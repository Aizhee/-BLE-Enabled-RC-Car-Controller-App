...
class _SettingsWidgetState extends State<SettingsWidget> {
  ...
  void initState() {
    ...
    _model.textController1 ??= TextEditingController(
        text: FFAppState().joystickmap.elementAtOrNull(0));
    _model.textFieldFocusNode1 ??= FocusNode();

    _model.textController2 ??= TextEditingController(
        text: FFAppState().joystickmap.elementAtOrNull(1));
    _model.textFieldFocusNode2 ??= FocusNode();

    _model.textController3 ??= TextEditingController(
        text: FFAppState().joystickmap.elementAtOrNull(2));
    _model.textFieldFocusNode3 ??= FocusNode();

    _model.textController4 ??= TextEditingController(
        text: FFAppState().joystickmap.elementAtOrNull(3));
    _model.textFieldFocusNode4 ??= FocusNode();

    _model.textController5 ??= TextEditingController(
        text: FFAppState().joystickmap.elementAtOrNull(4));
    _model.textFieldFocusNode5 ??= FocusNode();

    _model.textController6 ??= TextEditingController(
        text: FFAppState().joystickmap.elementAtOrNull(5));
    _model.textFieldFocusNode6 ??= FocusNode();

    _model.textController7 ??= TextEditingController(
        text: FFAppState().joystickmap.elementAtOrNull(6));
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              FFAppState().buttons =
                                  _model.buttons!.toList().cast<String>();
                              FFAppState().slidersbits =
                                  _model.startbits!.toList().cast<String>();
                              FFAppState().slidervals =
                                  _model.slidervalues!.toList().cast<int>();
                              safeSetState(() {});
